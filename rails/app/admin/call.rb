...
##Customer
ActiveAdmin.register Call, namespace: :customers do
  ...
  controller do
    def scoped_collection
      Call.where(dialstatus: "ANSWER", customer: current_customer)
    end
  end
  ...
  index do
    ...
    column "Cost", :price_for_customer
    column :ip
    actions
  end
